...
{
    return (
        <main className="w-full mt-24 md:mt-28 mb-4 flex justify-center items-center">
            <div className="w-full mx-2 md:w-11/12 rounded-lg md:px-4 pb-4 flex items-center justify-center flex-col">
