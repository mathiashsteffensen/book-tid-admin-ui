...
export default function CalendarSettings({
    ...
    return (
        <div className="md:w-full my-2 w-10/12 bg-gray-100 rounded px-4 py-3 lg:py-2 shadow-sm flex flex-col lg:flex-row justify-between items-center">
            ...
            <span className="lg:h-0 h-4"></span>
            <Input
                className="lg:w-92"
