...
export interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
    variant?: 'primary' | 'secondary' | 'light' | 'dark' | 'info' | 'warning' | 'danger' | 'success' | 'outline-primary' | 'outline-secondary' | 'outline-light' | 'outline-dark' | 'outline-info' | 'outline-warning' | 'outline-danger',
    size?: 'sm' | 'lg'
}
