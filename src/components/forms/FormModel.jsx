...
export default function FormModel({
    ...
    return (
        <form
            onChange={resetError}
            className="outline-none my-4 max-w-screen min-w-2/3-screen w-full z-10 flex flex-col justify-center items-center bg-white rounded shadow pb-8 h-full overflow-hidden"
        >
