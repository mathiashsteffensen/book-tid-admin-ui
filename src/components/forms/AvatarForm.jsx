...
import {uploadAvatar, getAvatars, updateAvatar, deleteAvatar} from '../../requests'
...
export default function AvatarForm({closeForm, formProps}) 
{
    ...
    const handleUpload = () =>
    {
        uploadAvatar(localStorage.getItem('apiKey'), calendarID, fileInput.current.files[0])
        .then(update)
        ...
        >
            <div className="my-4 flex flex-col justify-center items-center">
                ...
                <div className="w-full flex justify-between items-center">
                    <input type="file" name="avatar" id="avatar" ref={fileInput}/>
                    <Button
                        color="primary"
            ...
            <PhotoGrid deletePhoto={deletePhoto} usePhoto={usePhoto} photos={avatars} />
