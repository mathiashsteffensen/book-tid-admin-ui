...
import {TextField, Button, IconButton, Select, MenuItem, Checkbox, Switch} from '@material-ui/core'
...
export default function AddService({closeForm, formProps}) 
{
    ...
    const handleSubmit = () =>
    {
        ...
        createService(localStorage.getItem('apiKey'), data).then(() => closeForm()).catch((err) => setError(err.response.data.msg))
    }
                    ...
                    <div className="flex w-full md:w-1/2 flex-col justify-between items-center">
                        ...
                        {calendars ? 
                            <Autocomplete
                                ...
                                renderInput={(params) => {
                                    return <TextField {...params} onChange={(e) => console.log(e.target)} variant="outlined" label="Hvem kan udføre servicen" />
                                }}
                            />
                        : null}
